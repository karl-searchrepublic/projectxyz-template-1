...
export function MobileCtaBar({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex gap-2 bg-primary p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] shadow-[0_-2px_10px_rgba(0,0,0,0.1)] md:hidden">
      {phone && (
